...
HD_PWD='/media/wei/DATA/LW/Project/Vivado_Project/IP_Cores_PanoSETI/wr_cores_panoseti/wr-cores-Quabo/syn/wrc_board_quabo_ip/wrc_board_quabo_ip.runs/synth_2'
cd "$HD_PWD"
