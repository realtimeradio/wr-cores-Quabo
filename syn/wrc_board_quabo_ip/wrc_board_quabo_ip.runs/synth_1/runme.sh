...
HD_PWD='/media/wei/DATA/LW/Project/WR_Project/WR_Reference_Design/wr-cores-acme1-vivado-Streamers-light/wr-cores-Quabo/syn/wrc_board_quabo_ip/wrc_board_quabo_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrc_board_quabo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrc_board_quabo.tcl
